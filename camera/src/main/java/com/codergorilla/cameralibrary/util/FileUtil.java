package com.codergorilla.cameralibrary.util;
...
public class FileUtil {
    ...
    private static String DST_FOLDER_NAME = "DCIM/JCamera";
...
//        DST_FOLDER_NAME = dir;
     ...
     * @return
     */
    public static String getJCameraPath() {
        File file = new File("/storage/emulated/0/DCIM/jcamera");
        if (!file.exists()) {
            file.mkdirs();
        }
